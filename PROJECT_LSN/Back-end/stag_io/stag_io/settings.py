"""
Django settings for stag_io project.
...
SECRET_KEY = 'django-insecure-=t*+copwill^!v@0#lza(u%jlx^_d5%b@sd4tts3$=g+^hm&@u'
...
WSGI_APPLICATION = 'stag_io.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    'TAGS': [
        ...
        {'name': 'Student', 'description': 'Student registration & profile'},
